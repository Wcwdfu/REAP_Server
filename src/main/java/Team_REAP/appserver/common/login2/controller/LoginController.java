...
import Team_REAP.appserver.common.login2.dto.LoginResponse;
...
public class LoginController {
    ...
    public ResponseEntity<LoginResponse> kakaoCallback(@RequestParam String accessToken){
        ...
        // 3. JWT 생성
        String customAccessToken = jwtUtil.generateAccessToken(member.getEmail(), member.getUserRole());
        String customRefreshToken = jwtUtil.generateRefreshToken(member.getEmail(), member.getUserRole());
        tokenService.saveTokenInfo(email, customAccessToken, customRefreshToken);
